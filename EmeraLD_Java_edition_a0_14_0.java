...
public class EmeraLD_Java_edition_a0_14_0 extends JFrame {
    //the version
    private static final String VERSION = "a0.14.0";
    private final GameCanvas canvas;
    private final String splash;
    public EmeraLD_Java_edition_a0_14_0() {
       ...
       //the welcome stuff & splashes
        ...
        "( ͡° ͜ʖ ͡°) (╯°□°）╯︵ ┻━┻ ¯\\_(ツ)_/¯ ಠ_ಠ (ง'̀-'́)ง ┬─┬ノ( º _ ºノ)", "it kinda lags while loading the ASCII art one XD", "you're welcome here!", "dont even joke mate.", "!£$%^&*()_+-=}{]{~@:?></|`¬", "Penalty to rangers"};
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(EmeraLD_Java_edition_a0_14_0::new);
    }
}
...
//the computer key whisperer (james) :D
    ...
    private void render() {
        ...
        g.setColor(Color.WHITE);
       if (keys[KeyEvent.VK_F5]) g.drawString(String.format("XYZ: %.3f / %.3f / %.3f | RotX: %.2f | RotY: %.1f | Blocks: %d | %h | %o | Java: %s ", -camX, -camY, camZ, Math.toDegrees(rotY), Math.toDegrees(rotX) % 360, world.size(), (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024 / 1024, Runtime.getRuntime().maxMemory() / 1024 / 1024, System.getProperty("java.version")), 20, 100);
        g.drawString("EmeraLD a0.14.0", 20, 60);
